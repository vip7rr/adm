...
msg -ama " $(fun_trans "Sistema Preparado Para Receber o OPENVPN")"
msg -bar
}
add_repo () {
...
msg -ama "$(fun_trans "Primeiro precisamos do ip de sua maquina, este ip esta correto?")\033[0m"
...
msg -bar
msg -ama "$(fun_trans "Agora Precisamos da Porta Que Esta Seu Proxy Squid(Socks)")"
msg -ama "$(fun_trans "Se nao Existir Proxy na Porta um Proxy Python sera Aberto!")"
msg -bar
while [[ $? != "1" ]]; do
...
no_port () {
msg -ama " $(fun_trans "Antes de instalar o openvpn Instalar um Squid")"
msg -bar
msg -ama " $(fun_trans "ou Abra um Proxy Socket")"
msg -bar
exit 1
}
